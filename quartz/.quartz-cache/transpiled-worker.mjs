...
var OxHugoFlavouredMarkdown = /* @__PURE__ */ __name((userOpts) => {
...
var FileTrieNode = class _FileTrieNode {
  ...
  data;
  depth;
  constructor(segments, data, depth) {
    this.children = [];
  ...
  makeChild(path11, file) {
    ...
    const child = new _FileTrieNode(fullPath, file, this.depth + 1);
...
var FolderContent_default = /* @__PURE__ */ __name((opts) => {
  ...
  const FolderContent = /* @__PURE__ */ __name((props) => {
    ...
    const content = tree.children.length === 0 ? fileData.description : htmlToJsx(fileData.filePath, tree);
    return /* @__PURE__ */ jsx11("div", { class: "popover-hint", children: /* @__PURE__ */ jsx11("article", { class: classes, children: content }) });
  }, "FolderContent");
...
import { jsx as jsx12, jsxs as jsxs5 } from "preact/jsx-runtime";
var NotFound = /* @__PURE__ */ __name(({ cfg }) => {
  const url = new URL(`https://${cfg.baseUrl ?? "example.com"}`);
  const baseDir = url.pathname;
  return /* @__PURE__ */ jsxs5("article", { class: "popover-hint", children: [
...
var Darkmode = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
  return /* @__PURE__ */ jsxs6("button", { class: classNames(displayClass, "darkmode"), children: [
    /* @__PURE__ */ jsxs6(
      "svg",
      {
...
import { jsx as jsx15, jsxs as jsxs7 } from "preact/jsx-runtime";
var ReaderMode = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
  return /* @__PURE__ */ jsx15("button", { class: classNames(displayClass, "readermode"), children: /* @__PURE__ */ jsxs7(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      xmlnsXlink: "http://www.w3.org/1999/xlink",
...
import { jsx as jsx16, jsxs as jsxs8 } from "preact/jsx-runtime";
...
import { Fragment as Fragment3, jsx as jsx17, jsxs as jsxs9 } from "preact/jsx-runtime";
var CustomOgImagesEmitterName = "CustomOgImages";

// quartz/components/Head.tsx
import { Fragment as Fragment4, jsx as jsx18, jsxs as jsxs10 } from "preact/jsx-runtime";
var Head_default = /* @__PURE__ */ __name(() => {
  const Head = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsxs10("head", { children: [
      ...
      !usesCustomOgImage && /* @__PURE__ */ jsxs10(Fragment4, { children: [
...
import { jsx as jsx22, jsxs as jsxs11 } from "preact/jsx-runtime";
var OverflowList = /* @__PURE__ */ __name(({
  children,
  ...props
}) => {
  return /* @__PURE__ */ jsxs11("ul", { ...props, class: [props.class, "overflow"].filter(Boolean).join(" "), id: props.id, children: [
    children,
...
var TableOfContents_default = /* @__PURE__ */ __name((opts) => {
  ...
  const TableOfContents2 = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsxs12("div", { class: classNames(displayClass, "toc"), children: [
      /* @__PURE__ */ jsxs12(
        "button",
        {
          type: "button",
  ...
  const LegacyTableOfContents = /* @__PURE__ */ __name(({ fileData, cfg }) => {
    ...
    return /* @__PURE__ */ jsxs12("details", { class: "toc", open: !fileData.collapseToc, children: [
    ...
    return /* @__PURE__ */ jsxs13(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx24("template", { id: "template-folder", children: /* @__PURE__ */ jsxs13("li", { children: [
            /* @__PURE__ */ jsx24("div", { class: "folder-container", children: /* @__PURE__ */ jsx24("div", { children: /* @__PURE__ */ jsx24("button", { class: "folder-button", children: /* @__PURE__ */ jsx24("span", { class: "folder-title" }) }) }) }),
...
import { jsx as jsx26, jsxs as jsxs14 } from "preact/jsx-runtime";
...
var Graph_default = /* @__PURE__ */ __name((opts) => {
  const Graph = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ jsxs14("div", { class: classNames(displayClass, "graph"), children: [
...
var Backlinks_default = /* @__PURE__ */ __name((opts) => {
  ...
  const Backlinks = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsxs15("div", { class: classNames(displayClass, "backlinks"), children: [
...
var Search_default = /* @__PURE__ */ __name((userOpts) => {
  const Search = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ jsxs16("div", { class: classNames(displayClass, "search"), children: [
      /* @__PURE__ */ jsxs16("button", { class: "search-button", children: [
        /* @__PURE__ */ jsx28("p", { children: i18n(cfg.locale).components.search.title }),
        /* @__PURE__ */ jsxs16("svg", { role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 19.9 19.7", children: [
      ...
      /* @__PURE__ */ jsx28("div", { class: "search-container", children: /* @__PURE__ */ jsxs16("div", { class: "search-space", children: [
        /* @__PURE__ */ jsx28(
          "input",
          {
            autocomplete: "off",
...
import { jsx as jsx29, jsxs as jsxs17 } from "preact/jsx-runtime";
...
import { jsx as jsx33, jsxs as jsxs19 } from "preact/jsx-runtime";
...
var Breadcrumbs_default = /* @__PURE__ */ __name((opts) => {
  ...
  const Breadcrumbs = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsx33("nav", { class: classNames(displayClass, "breadcrumb-container"), "aria-label": "breadcrumbs", children: crumbs.map((crumb, index) => /* @__PURE__ */ jsxs19("div", { class: "breadcrumb-element", children: [
...
var defaultContentPageLayout = {
  ...
  left: [
    ...
    Explorer_default({
      ...
      useSavedState: true,
      sortFn: /* @__PURE__ */ __name((a, b) => {
        const weightA = a.data?.weight !== void 0 ? a.data.weight : Infinity;
        const weightB = b.data?.weight !== void 0 ? b.data.weight : Infinity;
        if (weightA !== weightB) {
      ...
      for (const [tree, file] of content) {
        ...
        if (opts?.includeEmptyFiles || file.data.text && file.data.text !== "") {
          linkIndex.set(slug, {
            ...
            weight: file.data.frontmatter?.weight
          });
        }
      }
...
var config = {
  configuration: {
    ...
    locale: "en-US",
    baseUrl: "softwarearchitecture.fr",
  ...
  plugins: {
    transformers: [
      FrontMatter({ delimiters: "+++", language: "toml" }),
      OxHugoFlavouredMarkdown(),
      GitHubFlavoredMarkdown(),
      CreatedModifiedDate({
        priority: ["frontmatter", "git", "filesystem"]
...
var PerfTimer = class {
  ...
  timeSince(evtName) {
    return chalk7.yellow(pretty(process.hrtime(this.evts[evtName ?? "start"])));
  }
};
